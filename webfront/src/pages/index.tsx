        ...
        <header className="absolute inset-x-0 top-0 z-50">
          <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
              <a href="#" className="font-semibold text-xl text-slate-70 flex flex-row items-center leading-1" >
                <span className="text-white">AgendeSaúde</span>
                <FaCalendar />
              </a>
            </div>
            <div className="hidden lg:flex lg:gap-x-12">
              <Link to='/' className="font-semibold text-lg text-slate-50">Home</Link>
              <a href="#" className="font-semibold text-lg text-salte-50">Sobre o site</a>
              <a href="#" className="font-semibold text-lg text-slate-50">Como funciona?</a>
              <a href="#" className="font-semibold text-lg text-salte-50">GitHub</a>
            </div>
            <div className="hidden lg:flex lg:flex-1 lg:justify-end">
              <Link to='/login' className=" block rounded-lg px-3 py-2.5 text-base font-semibold text-lg text-slate-50">
        ...
        <div className="relative isolate px-4 lg:px-12">
          <div className="mx-auto max-w-5xl py-auto sm:py-28 lg:py-44 lg:mt-40">
            <div className="text-center">
              ...
              focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Entre na sua conta</Link>
              </div>
            </div>
          </div>
        </div>
